...
export const authMethods = mapActions('auth', ['setRoleUser', 'setToken', 'setUserId', 'setLayoutLogin', 'cerrarSesion','autenticationSet','logIn', 'logOut', 'register', 'resetPassword'])
